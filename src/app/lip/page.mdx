...
The Liquidity Incentive Program is a <Button href="https://github.com/mrgnlabs/marginfi-v2/tree/main/programs/liquidity-incentive-program" variant="text"><>fully open-sourced proxy program</></Button> for marginfi-v2, deployed on Solana's mainnet-beta. It allows anyone to create campaigns and incentivize other users to deposit into and lock their funds in marginfi-v2 by offering guaranteed yields. {{ className: 'lead' }}

The official LIP program address on Solana mainnet-beta is <Button href="https://solscan.io/account/LipsxuAkFkwa4RKNzn51wAsW7Dedzt1RNHMkTkDEZUW" variant="text"><>LipsxuAkFkwa4RKNzn51wAsW7Dedzt1RNHMkTkDEZUW</></Button>.
