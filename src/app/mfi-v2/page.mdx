...
<Properties>
  ...
  <Property name="BankNotFound" type="6001">
    The specified bank index is invalid or does not exist.
  </Property>

  <Property name="LendingAccountBalanceNotFound" type="6002">
    The lending account balance was not found.
  </Property>

  <Property name="BankAssetCapacityExceeded" type="6003">
    The deposit exceeds the bank's asset capacity.
  </Property>

  <Property name="InvalidTransfer" type="6004">
    The transfer operation is invalid.
  </Property>

  <Property name="MissingPythOrBankAccount" type="6005">
    Either the Pyth or Bank account is missing.
  </Property>

  <Property name="MissingPythAccount" type="6006">
    The Pyth account is missing.
  </Property>

  <Property name="InvalidOracleAccount" type="6007">
    The provided oracle account is invalid.
  </Property>
  ...
  <Property name="InvalidBankAccount" type="6009">
    The provided Bank account is invalid.
  </Property>

  <Property name="BadAccountHealth" type="6010">
    The account's health is bad.
  </Property>

  <Property name="LendingAccountBalanceSlotsFull" type="6011">
    The lending account balance slots are full.
  </Property>
  ...
  <Property name="IllegalLiquidation" type="6013">
    The liquidation operation is illegal.
  </Property>

  <Property name="AccountNotBankrupt" type="6014">
    The account is not bankrupt.
  </Property>

  <Property name="BalanceNotBadDebt" type="6015">
    The account balance is not considered bad debt.
  </Property>

  <Property name="InvalidConfig" type="6016">
    The group configuration is invalid.
  </Property>

  <Property name="StaleOracle" type="6017">
    The oracle data is stale or outdated.
  </Property>

  <Property name="BankPaused" type="6018">
    The bank is currently paused.
  </Property>

  <Property name="BankReduceOnly" type="6019">
    The bank is in reduce-only mode.
  </Property>
  ...
  <Property name="InvalidOracleSetup" type="6027">
    The oracle setup is invalid.
  </Property>

  <Property name="IllegalUtilizationRatio" type="6028">
    The bank utilization ratio is illegal.
  </Property>

  <Property name="BankLiabilityCapacityExceeded" type="6029">
    The bank's liability capacity has been exceeded.
  </Property>
  ...
  <Property name="IsolatedAccountIllegalState" type="6031">
    The isolated account is in an illegal state (e.g., having more than one liability).
  </Property>

  <Property name="EmissionsAlreadySetup" type="6032">
    Emissions have already been set up.
  </Property>

  <Property name="OracleNotSetup" type="6033">
    The oracle has not been set up.
  </Property>

  <Property name="InvalidSwitchboardDecimalConversion" type="6034">
    The Switchboard decimal conversion is invalid.
  </Property>

  <Property name="CannotCloseOutstandingEmissions" type="6035">
    Cannot close a balance with outstanding emissions.
  </Property>

  <Property name="EmissionsUpdateError" type="6036">
    An error occurred during emissions update.
  </Property>
  ...
  <Property name="AccountTempActiveBalanceLimitExceeded" type="6038">
    The temporary active balance limit for the account has been exceeded.
  </Property>

  <Property name="AccountInFlashloan" type="6039">
    The account is currently in a flashloan state.
  </Property>

  <Property name="IllegalFlashloan" type="6040">
    The flashloan operation is illegal.
  </Property>

  <Property name="IllegalFlag" type="6041">
    The provided flag is illegal.
  </Property>

  <Property name="IllegalBalanceState" type="6043">
    The balance state is illegal.
  </Property>

  <Property name="IllegalAccountAuthorityTransfer" type="6044">
    The account authority transfer is illegal.
  </Property>
